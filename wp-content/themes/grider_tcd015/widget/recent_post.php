<?php
 ...
 function recent_widget() {
  $widget_ops = array( 'classname' => 'recent_widget', 'description' => __('Displays your recent posts.', 'tcd-w') ); // Widget Settings
  $control_ops = array( 'id_base' => 'recent_widget' ); // Widget Control Settings
  parent::__construct( 'recent_widget', __('Recent post (tcd-w ver)', 'tcd-w'), $widget_ops, $control_ops ); // Create the widget
 }
...
<ol class="widget_post_list">
 <?php $options = get_desing_plus_option(); while ($recent_post->have_posts()) : $recent_post->the_post(); ?>
 <li class="clearfix">
...
<?php
 ...
 function form($instance) {
  $defaults = array( 'title' => __('Recent post', 'tcd-w'), 'post_num' => '3');
...
// End class widget
add_action('widgets_init', create_function('', 'return register_widget("recent_widget");'));
?>