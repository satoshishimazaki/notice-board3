...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_grider.xml';
	
	$db_cache_field = 'grider-contempo-notifier-cache';
	$db_cache_field_last_updated = 'grider-contempo-notifier-last-updated';
