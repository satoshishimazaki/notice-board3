...
<meta name="globalsign-domain-verification" content="8uB3bzZVo6rVeHqZDmkbxB_sBWi_toa-L4TVCHkQai" />
...
<script type="text/javascript">jQuery(function() {  
    jQuery("a").click(function(e) {        
        ...
        if (ahref.indexOf("musashikosugi.nowhere.plus") != -1 || ahref.indexOf("http") == -1 ) {
...
<div class="fb-page" data-href="https://www.facebook.com/nowhere.musashikosugi/" data-width="210" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/nowhere.musashikosugi/"><a href="https://www.facebook.com/nowhere.musashikosugi/">武蔵小杉 now here</a></blockquote></div></div>
<div id="fb-root"></div>
<script>(function(d, s, id) {
  var js, fjs = d.getElementsByTagName(s)[0];
  if (d.getElementById(id)) return;
  js = d.createElement(s); js.id = id;
  js.src = "//connect.facebook.net/ja_JP/sdk.js#xfbml=1&version=v2.5&appId=1507363059540946";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
<a href="https://twitter.com/Kosugi_Now_here" class="twitter-follow-button" data-show-count="false" data-size="large" data-show-screen-name="false">Follow @Kosugi_Now_here</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
   <p id="user_policy"><a href="http://musashikosugi.nowhere.plus/?page_id=54">利用規約</a></p>
   <p id="privacy_policy"><a href="http://musashikosugi.nowhere.plus/?page_id=48 ">プライバシーポリシー</a></p>
