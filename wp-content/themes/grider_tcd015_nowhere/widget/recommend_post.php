<?php
 ...
 function recommend_widget() {
  ...
  parent::__construct( 'recommend_widget', __('Recommend post (tcd-w ver)', 'tcd-w'), $widget_ops, $control_ops ); // Create the widget
 }
...
<?php
 ...
 function form($instance) {
  $defaults = array( 'title' => __('Recommend post', 'tcd-w'), 'post_num' => '3');
